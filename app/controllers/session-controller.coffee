...
module.exports = class SessionController extends Controller
  ...
  initialize: ->
    ...
    @subscribeEvent 'loginSuccessful', @loginCallback
  ...
  getSession: ->
    @loadServiceProviders()
    for name, serviceProvider of SessionController.serviceProviders
      serviceProvider.done serviceProvider.getLoginStatus(@publishEvent '!showLogin')

  # Handler for the global !showLogin event
  showLoginView: ->
    #console.log 'SessionController#showLoginView'
    return if @loginView
    @loadServiceProviders()
  ...
  triggerLogin: (serviceProviderName) =>
    #console.log 'SessionController#triggerLogin'
  ...
  serviceProviderSession: (session) =>
    #console.log 'SessionController#serviceProviderSession', session
